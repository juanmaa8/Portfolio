    ...
    projects: [
      {
        ...
        shortDesc:
          "Development of a central Power BI dashboard connecting directly to SQL to track domestic vs. international sales in real-time.",
        challenge:
          "The company relied on manual Excel reports, causing delays. There was no clear visibility into SKU-level profitability or consolidated international sales data.",
        solution:
          "I connected the Sage ERP to a SQL database to normalize the data, then built a Power BI dashboard with automated refresh. I implemented DAX measures to calculate real margins per SKU.",
        results: [
      ...
      },
      {
        ...
        shortDesc:
          "Created a tracking system using KQL to measure how often reports were being used by the management team.",
        challenge:
          "We didn't know which reports were actually useful. It was hard to justify spending time on reports without knowing if they were being adopted.",
        solution:
          "I wrote KQL (Kusto Query Language) scripts to analyze Power BI Activity Logs. This allowed us to see who was viewing which report and how frequently.",
        results: [
      ...
      },
      {
        ...
        shortDesc:
          "Set up a structured system to track data requests and document standard operating procedures (SOPs).",
        challenge:
          "Ad-hoc requests were disorganized, making it hard to prioritize work or show the value of the BI function to leadership.",
        solution:
          "Implemented a simple Kanban-style intake process in Notion. I categorized tasks by 'Strategic' vs 'Maintenance' to visualize my workload.",
        results: [
    ...
    projects: [
      {
        ...
        shortDesc:
          "Desarrollo de un dashboard central en Power BI conectado directamente a SQL para rastrear ventas domésticas vs internacionales en tiempo real.",
        challenge:
          "La empresa dependía de reportes manuales en Excel, causando retrasos. No había visibilidad clara sobre la rentabilidad a nivel de SKU ni datos consolidados de ventas internacionales.",
        solution:
          "Conecté el ERP Sage a una base de datos SQL para normalizar los datos, luego construí un dashboard en Power BI con actualización automática. Implementé medidas DAX para calcular márgenes reales por SKU.",
        results: [
      ...
      },
      {
        ...
        gallery: ["/images/engagement-KQL.png", "/images/adopcion-KQL.png", "/images/code-KQL.png"],
        shortDesc:
          "Creación de un sistema de seguimiento usando KQL para medir con qué frecuencia el equipo directivo utilizaba los reportes.",
        challenge:
          "No sabíamos qué reportes eran realmente útiles. Era difícil justificar el tiempo dedicado a reportes sin saber si estaban siendo adoptados.",
        solution:
          "Escribí scripts en KQL (Kusto Query Language) para analizar los Logs de Actividad de Power BI. Esto nos permitió ver quién veía qué reporte y con qué frecuencia.",
        results: [
      ...
      },
      {
        ...
        gallery: ["/images/track-requests.png"],
        shortDesc:
          "Implementación de un sistema estructurado para rastrear solicitudes de datos y documentar procedimientos operativos estándar (SOPs).",
        challenge:
          "Las solicitudes ad-hoc estaban desorganizadas, dificultando priorizar el trabajo o mostrar el valor de la función de BI al liderazgo.",
        solution:
          "Implementé un proceso de entrada simple tipo Kanban en Notion. Categoricé las tareas por 'Estratégicas' vs 'Mantenimiento' para visualizar mi carga de trabajo.",
        results: [
  ...
  return (
    ...
    >
          ...
          <div className="text-center p-6 transition-transform duration-500 group-hover:-translate-y-1">
            <div className="w-12 h-12 border border-slate-200 bg-white flex items-center justify-center rounded-sm mx-auto mb-4">
              {project.id === 1 ? (
                ...
                <Code2 className="text-slate-900" />
              ) : (
      ...
      <div className="p-8 flex-1 flex flex-col">
        <h3 className="font-serif text-2xl text-slate-900 mb-3 leading-tight group-hover:text-blue-900 transition-colors">
          {project.title}
        </h3>
      ...
      >
        <div className="container mx-auto px-6 md:px-12 flex justify-between items-center">
          <div className="flex flex-col cursor-pointer group" onClick={() => scrollToSection("hero")}>
            ...
            <span className="text-[10px] font-sans font-medium tracking-[0.2em] text-slate-500 uppercase">
              {t.nav.role}
            </span>
          </div>
